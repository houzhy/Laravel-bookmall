...
@section('content')
	...
	<div class="top_box">
		<div class="top_left">
			...
			<ul>
				...
				<li><a href="{{url('admin/info')}}" target="main">后台首页</a></li>
			</ul>
		</div>
		<div class="top_right">
			<ul>
		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
					...
					<li><a href="{{url('admin/article/create')}}" target="main"><i class="fa fa-plus"></i>添加文章</a></li>
					<li><a href="{{url('admin/article')}}" target="main"><i class="fa fa-recycle"></i>全部文章</a></li>
                </ul>
            </li>
            <li>
	...
	<div class="bottom_box">
		CopyRight © 2016. Powered By <a href="http://www.phpclass.top">http://www.phpclass.top</a>.
	</div>
	<!--底部 结束-->
@stop