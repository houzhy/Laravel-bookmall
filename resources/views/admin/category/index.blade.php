            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                            {{--<button onchange="changeOrder({{$v->cate_order}},{{$v->cate_id}},1)" type="button" class="btn btn-default" aria-label="Left Align">--}}
                                {{--<span class="glyphicon glyphicon-arrow-up" aria-hidden="true"></span>--}}
                            {{--</button>--}}
                            {{--<button onchange="changeOrder({{$v->cate_order}},{{$v->cate_id}},0)" type="button" class="btn btn-default" aria-label="Left Align">--}}
