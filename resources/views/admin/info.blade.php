...
@section('content')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 系统详情信息
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>php超时时间</label><span>{{get_cfg_var("max_execution_time").'s'}}</span>
                </li>
                <li>
                ...
                <li>
                    <label>客户端Host</label><span>{{$_SERVER['REMOTE_ADDR']}}</span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>技术交流：</label><span><a href="#">http://bbs.phpclass.top</a></span>
                </li>
                <li>
