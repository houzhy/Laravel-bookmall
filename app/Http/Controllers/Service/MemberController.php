...
use App\Tool\UUID;
use App\Http\Model\Book\Member;
use App\Http\Model\Book\TempPhone;
use App\Http\Model\Book\TempEmail;
...
class MemberController extends Controller
{
  public function register(Request $request) {
    ...
    // 邮箱注册
      ...
      $m3_email->to = $email;
      $m3_email->cc = '444169097@qq.com';
      $m3_email->subject = '凯恩书店验证';
      $m3_email->content = '请于24小时点击该链接完成验证. http://book.my_laravel.com/service/validate_email'
                        . '?member_id=' . $member->id
                        . '&code=' . $uuid;
      ...
      Mail::send('book/email_register', ['m3_email' => $m3_email], function ($m) use ($m3_email) {
